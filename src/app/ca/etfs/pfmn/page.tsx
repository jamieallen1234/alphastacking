    ...
    <main className={styles.main}>
      ...
      <section className={styles.section}>
        ...
        <ul className={styles.meta}>
          <li>
            <strong>Ticker:</strong> PFMN
          </li>
          <li>
            <strong>Manager:</strong> Picton Mahoney Asset Management
          </li>
          <li>
            <strong>Inception:</strong> July 16, 2019
          </li>
          <li>
            <strong>Beta:</strong>{' '}
            {initialChart.betaVsSpy1y != null ? initialChart.betaVsSpy1y.toFixed(2) : '—'}
          </li>
          <li>
            <strong>MER:</strong> 1.25%
          </li>
          <li>
            <strong>AUM:</strong> ~$58M CAD
          </li>
        </ul>

        <h2 className={styles.chartHeading}>PFMN.TO price history</h2>
        <EtfChartPanel symbol="PFMN.TO" initialPayload={initialChart} />
