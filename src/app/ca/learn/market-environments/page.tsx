...
export default async function CaMarketEnvironmentsPage() {
  ...
  return (
    <LearnArticleShell edition="ca" currentSlug={MARKET_ENVIRONMENTS_SLUG}>
      <MarketEnvironmentsArticle edition="ca" timestamps={timestamps} values={values} />
    </LearnArticleShell>
  )
}
