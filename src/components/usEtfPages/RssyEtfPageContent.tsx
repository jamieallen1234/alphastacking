...
import styles from '@/app/us-etfs/rssy/page.module.css'

export default async function RssyEtfPageContent({ hubBase }: { hubBase: UsEtfHubBase }) {
  ...
  return (
    <EtfPageTemplate
      ...
      heading="RSSY — Return Stacked U.S. Stocks & Futures Yield ETF"
      lede={
        <>
      ...
      meta={{
        ticker: 'RSSY',
        issuerOrManager: 'Tidal Trust II / Tidal Investments LLC (adviser)',
        inception: 'May 28, 2024',
        mer: '0.98%',
        aum: '~$96M',
        beta: betaVsSpyDisplay(rssyChart),
      }}
      chart={{ displayLabel: 'RSSY', yahooSymbol: 'RSSY', payload: rssyChart }}
      styles={styles}
    >
