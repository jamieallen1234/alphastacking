...
const EXPOSURE_BY_TICKER: Record<string, ExposureModel> = {
  ...
  WX: { longEquityPct: 200, shortEquityPct: 0, alphaPct: 0 },
  ...
  AVDV: { longEquityPct: 100, shortEquityPct: 0, alphaPct: 0 },
  ...
  NTSX: { longEquityPct: 90, shortEquityPct: 0, alphaPct: 60 },
  NTSI: { longEquityPct: 90, shortEquityPct: 0, alphaPct: 60 },
  NTSE: { longEquityPct: 90, shortEquityPct: 0, alphaPct: 60 },
  ...
  'RGBM.TO': { longEquityPct: 50, shortEquityPct: 0, alphaPct: 150 },
  ...
  HARD: { longEquityPct: 0, shortEquityPct: 0, alphaPct: 100 },
