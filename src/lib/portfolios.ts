...
export const portfolios: Portfolio[] = [
  {
    ...
    badge: '★ Core strategy',
    featured: true,
    name: 'US Efficient Core',
    description: 'MATE + SPMO + IALT. Return-stacked managed futures core with momentum and systematic alternatives.',
  ...
  },
  {
    ...
    description: 'USSL.TO + QQQL.TO + DGLM.TO + PFMN.TO. Leveraged S&P 500 and Nasdaq core with managed futures and market-neutral.',
